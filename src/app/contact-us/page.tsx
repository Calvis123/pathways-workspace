...
export default function ContactUsPage() {
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f4f8fb_0%,#ffffff_26%,#f5f8fe_100%)] text-slate-900">
      <Navbar />
      ...
      <main>
        <section className="border-b border-[#e1e8f2] bg-white">
          <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 sm:py-16">
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
              <div className="max-w-3xl">
                ...
                <div className="mt-8 flex flex-wrap gap-6 text-sm text-slate-600">
                  <div className="inline-flex items-center gap-2">
                    <MapPin className="h-4 w-4 text-[#1f62e4]" />
                    Kenya-focused support
                  </div>
                  <div className="inline-flex items-center gap-2">
                    <Phone className="h-4 w-4 text-[#1f62e4]" />
                    +254 113 043 315
                  </div>
                  <div className="inline-flex items-center gap-2">
                    <Clock3 className="h-4 w-4 text-[#1f62e4]" />
                    Mon-Sat available
                  </div>
                </div>
              ...
              <div className="overflow-hidden rounded-[34px] border border-[#cddbf7] bg-[linear-gradient(135deg,#05263d_0%,#1f62e4_50%,#4f8ff0_100%)] p-8 text-white shadow-[0_24px_70px_rgba(31,98,228,0.18)] sm:p-10">
                ...
                <div className="mt-6 grid gap-4">
                  {benefits.map((item) => (
                    <div key={item} className="flex items-start gap-3 rounded-2xl border border-white/12 bg-white/10 px-4 py-4 backdrop-blur">
                      <ShieldCheck className="mt-0.5 h-5 w-5 shrink-0 text-[#eef1f5]" />
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {contactMethods.map((item) => {
                ...
                return (
                  <article
                    key={item.title}
                    className={`rounded-[30px] border p-6 shadow-[0_18px_50px_rgba(31,98,228,0.08)] ${
                      item.featured
                        ? 'border-[#8cb9ff] bg-[linear-gradient(180deg,#f4f8fb_0%,#ffffff_100%)]'
                        : 'border-[#cddbf7] bg-white'
                    }`}
                  >
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#edf4ff_0%,#ffffff_100%)] text-[#1f62e4] shadow-[0_12px_30px_rgba(31,98,228,0.08)] ring-1 ring-[#cddbf7]">
                      <Icon className="h-6 w-6" />
                    </div>
                    <h2 className="mt-5 text-2xl font-semibold text-slate-950">{item.title}</h2>
                    <p className="mt-3 text-sm leading-7 text-slate-600">{item.description}</p>
                    <div className="mt-5 text-sm font-semibold text-[#1f62e4]">{item.value}</div>
                    <Link
                      href={item.href}
                      ...
                      className={`mt-6 inline-flex h-12 w-full items-center justify-center rounded-full text-sm font-semibold transition ${
                        item.featured
                          ? 'bg-[#1f62e4] text-white hover:bg-[#174fbf]'
                          : 'border border-[#cddbf7] text-slate-900 hover:border-[#1f62e4] hover:bg-[#1f62e4] hover:text-white'
                      }`}
                    >
                      {item.cta}
                      <ArrowRight className="ml-2 h-4 w-4" />
        ...
        <section className="bg-[linear-gradient(180deg,#f4f8fb_0%,#ffffff_100%)] py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-2xl">
                ...
                <div className="mt-8 grid gap-4">
                  {[
                    ...
                    <div
                      key={item}
                      className="rounded-2xl border border-[#cddbf7] bg-white px-5 py-4 text-sm font-medium text-slate-700 shadow-[0_12px_30px_rgba(31,98,228,0.05)]"
                    >
                      {item}
                    </div>
                  ))}
              ...
              <div className="grid gap-4">
                {infoPanels.map((panel) => {
                  ...
                  return (
                    <article
                      key={panel.title}
                      className="rounded-[28px] border border-[#cddbf7] bg-white p-6 shadow-[0_16px_40px_rgba(31,98,228,0.06)]"
                    >
                      <div className="flex items-start gap-4">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#edf4ff_0%,#ffffff_100%)] text-[#1f62e4] ring-1 ring-[#cddbf7]">
        ...
        <section className="pb-16 pt-16 sm:pb-24 sm:pt-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="overflow-hidden rounded-[34px] bg-[linear-gradient(135deg,#05263d_0%,#1f62e4_46%,#4f8ff0_100%)] p-8 text-white shadow-[0_28px_80px_rgba(31,98,228,0.22)] sm:p-10">
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                ...
                <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                  <Link
                    href="https://wa.me/254113043315?text=Hi%2C%20I%27m%20interested%20in%20studying%20abroad%20through%20Barak%20Pathways"
                    target="_blank"
                    className="inline-flex h-12 items-center justify-center rounded-full bg-[#eef1f5] px-6 text-sm font-semibold text-slate-950 transition hover:bg-[#dde5ef]"
                  >
                    WhatsApp us
                  </Link>
                  <ConsultationPopupTrigger
