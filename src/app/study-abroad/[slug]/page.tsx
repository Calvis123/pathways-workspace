...
export default async function DestinationPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f4f8fb_0%,#f8fdff_30%,#eef5f9_100%)] text-slate-900">
      <Navbar />

      <main>
        <section className="relative flex min-h-[680px] items-center overflow-hidden border-b border-[#cddbf7] bg-[linear-gradient(180deg,#f8fbff_0%,#eef5f9_100%)] text-slate-900 lg:min-h-[760px]">
          <div className="absolute inset-x-0 top-0 h-48 bg-[radial-gradient(circle_at_top_left,rgba(31,98,228,0.16),transparent_38%),radial-gradient(circle_at_top_right,rgba(79,143,240,0.18),transparent_30%)]" />
          <div className="absolute -left-24 top-24 h-64 w-64 rounded-full bg-[#1f62e4]/5 blur-3xl" />
          <div className="absolute right-0 top-12 h-72 w-72 rounded-full bg-[#eef1f5]/10 blur-3xl" />
          <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            ...
            <div className="relative mt-8 grid gap-10 lg:grid-cols-[0.98fr_1.02fr] lg:items-center">
              <div className="max-w-3xl lg:order-1">
                <div className="inline-flex items-center gap-2 rounded-full border border-[#dbe6f5] bg-white/90 px-4 py-2 text-sm font-medium text-slate-700 shadow-[0_12px_30px_rgba(31,98,228,0.08)] backdrop-blur">
                ...
                <div className="mt-8 flex flex-col gap-4 sm:flex-row">
                  <ConsultationPopupTrigger
                    ...
                    className={`inline-flex h-12 items-center justify-center rounded-full px-6 text-sm font-semibold text-white shadow-[0_16px_38px_rgba(31,98,228,0.18)] transition hover:-translate-y-0.5 ${detail.accentBg}`}
                    withArrow
                  />
                  <Link
                    href="#requirements"
                    className="inline-flex h-12 items-center justify-center rounded-full border border-[#cddbf7] bg-white px-6 text-sm font-semibold text-slate-900 shadow-[0_12px_30px_rgba(31,98,228,0.06)] transition hover:-translate-y-0.5 hover:bg-slate-50"
                  >
                    View requirements
                  </Link>
                </div>
                ...
                <div className="mt-8 grid gap-4 sm:grid-cols-3">
                  {destinationSignals.map((signal) => (
                    <div
                      key={signal.label}
                      className="rounded-[24px] border border-[#cddbf7] bg-white/90 p-5 shadow-[0_18px_45px_rgba(31,98,228,0.08)]"
                    >
        ...
        <section className="sticky top-16 z-30 border-y border-[#cddbf7] bg-white/80 backdrop-blur-xl">
          ...
          <section className="bg-[linear-gradient(180deg,#ffffff_0%,#f9fbff_100%)] py-14 sm:py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
                ...
                <div className="space-y-5 rounded-[30px] border border-[#cddbf7] bg-[linear-gradient(180deg,#ffffff_0%,#f8fdff_100%)] p-8 shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
        ...
        <section className="bg-[linear-gradient(180deg,#f8fbff_0%,#f4f8fb_100%)] py-14 sm:py-16">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
            <div className="rounded-[34px] border border-[#cddbf7] bg-[linear-gradient(180deg,#ffffff_0%,#f8fdff_100%)] p-8 shadow-[0_24px_70px_rgba(31,98,228,0.08)]">
              <div className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium ${detail.softAccent} ${detail.accentText}`}>
                <Icon icon={bookOutline} className="h-4 w-4" />
            ...
            <div className="grid gap-4">
              <div className="grid gap-4 sm:grid-cols-2">
                {overviewHighlights.map((item, index) => (
                  <div
                    key={item.label}
                    className={`rounded-[28px] border p-6 shadow-[0_16px_40px_rgba(31,98,228,0.06)] ${
                      index < 2
                        ? 'border-[#cddbf7] bg-white'
                        : 'border-[#e5ebf6] bg-[linear-gradient(180deg,#f4f8fb_0%,#ffffff_100%)]'
                    }`}
                  >
                    <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">
                      {item.label}
              ...
              <div className="rounded-[30px] border border-[#cddbf7] bg-white p-6 shadow-[0_18px_50px_rgba(31,98,228,0.08)]">
                <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <Link
                    href="#requirements"
                    className={`inline-flex h-11 items-center justify-center rounded-full px-5 text-sm font-semibold text-white shadow-[0_14px_36px_rgba(31,98,228,0.18)] transition hover:-translate-y-0.5 ${detail.accentBg}`}
                  >
                    Review requirements
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2">
                  {readinessChecklist.map((item) => (
                    <div
                      key={item}
                      className="flex items-start gap-3 rounded-2xl border border-[#d4e2ec] bg-[#f4f8fb] px-4 py-4"
                    >
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-5">
              {country.whyStudy.map((reason, index) => {
                ...
                return (
                  <div key={reason} className="rounded-[26px] border border-[#cddbf7] bg-[linear-gradient(180deg,#ffffff_0%,#f9fbff_100%)] p-6 shadow-[0_18px_50px_rgba(31,98,228,0.07)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(31,98,228,0.12)]">
        ...
        <section id="universities" className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 overflow-hidden rounded-[30px] border border-[#cddbf7] bg-white shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
        ...
        <section id="explore" className="bg-[linear-gradient(180deg,#f4f8fb_0%,#f1f6ff_100%)] py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="rounded-[32px] border border-[#cddbf7] bg-[linear-gradient(135deg,#1f62e4_0%,#4f8ff0_42%,#dde5ef_120%)] p-8 text-white shadow-[0_24px_70px_rgba(31,98,228,0.18)]">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                {secondaryRegions.map((region) => (
                  <article key={region} className="rounded-[26px] border border-[#cddbf7] bg-white p-6 shadow-[0_18px_50px_rgba(31,98,228,0.07)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(31,98,228,0.12)]">
        ...
        <section id="requirements" className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
              <div className="rounded-[30px] border border-[#cddbf7] bg-[linear-gradient(180deg,#f8fbff_0%,#ffffff_100%)] p-8 shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
                <div className={`inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium ${detail.softAccent} ${detail.accentText}`}>
              ...
              <div className="relative">
                <div className="absolute bottom-0 left-5 top-0 hidden w-px bg-[#cddbf7] md:block" />
                <div className="grid gap-4">
                {primaryApplicationSteps.map((item, index) => (
                  <div key={item} className="relative flex gap-4 rounded-[26px] border border-[#cddbf7] bg-white p-5 shadow-[0_16px_40px_rgba(31,98,228,0.07)] transition hover:-translate-y-0.5 hover:shadow-[0_22px_55px_rgba(31,98,228,0.12)]">
                ...
                {secondaryApplicationSteps.length > 0 && (
                  <details className="group rounded-[26px] border border-[#cddbf7] bg-[linear-gradient(180deg,#f8fbff_0%,#ffffff_100%)] p-5 shadow-[0_16px_40px_rgba(31,98,228,0.06)]">
                    ...
                    <div className="mt-4 grid gap-4">
                      {secondaryApplicationSteps.map((item, index) => (
                        <div key={item} className="relative flex gap-4 rounded-[20px] border border-[#cddbf7] bg-white p-5 shadow-sm">
                          <div className={`relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-sm font-semibold text-white ${detail.accentBg}`}>
        ...
        <section id="costs" className="bg-[#f7f9fc] py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="rounded-[30px] border border-[#cddbf7] bg-white p-8 shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
                ...
                <div className="mt-5 rounded-3xl border border-[#e4eaf4] bg-slate-50 p-6">
                  <div className="text-sm font-medium text-slate-500">Destination fit</div>
                  <div className="mt-2 text-2xl font-semibold text-[#1f62e4]">Course, intake, and university alignment</div>
                </div>
                <div className="mt-4 rounded-3xl border border-[#f2df9a] bg-[#fff5d6] p-6">
                  <div className="text-sm font-medium text-slate-500">Document readiness</div>
                  <div className="mt-2 text-2xl font-semibold text-slate-950">Checklist review and timeline planning</div>
                </div>
              ...
              <div className="rounded-[30px] border border-[#cddbf7] bg-white p-8 shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
                ...
                <div className="mt-6 overflow-hidden rounded-[24px] border border-[#cddbf7]">
                  <div className="grid grid-cols-[1.2fr_0.9fr_0.9fr] gap-4 bg-[linear-gradient(180deg,#f4f8fb_0%,#eef5f9_100%)] px-5 py-4 text-sm font-semibold text-slate-700">
                    <div>Checkpoint</div>
                    <div>Status</div>
                    <div>When</div>
                  </div>
                  {[
                    ...
                    <div
                      key={item.name}
                      className="grid grid-cols-1 gap-3 border-t border-[#e7edf6] px-5 py-4 text-sm text-slate-600 md:grid-cols-[1.2fr_0.9fr_0.9fr]"
                    >
        ...
        <section id="work" className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="rounded-[30px] border border-[#cddbf7] bg-[linear-gradient(180deg,#fbfcfe_0%,#eef5f9_100%)] p-8 shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
                <div className={`inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-medium shadow-sm ${detail.accentText}`}>
              ...
              <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                <div className="space-y-4">
                  {detail.realityCheck.map((point) => (
                    <div key={point} className="rounded-[26px] border border-[#cddbf7] bg-white p-5 shadow-[0_16px_40px_rgba(31,98,228,0.06)]">
        ...
        <section className="bg-white py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
              <div>
                ...
                <div className="mt-8 grid gap-4">
                  {country.testimonials.map((testimonial) => (
                    <article key={`${testimonial.name}-${testimonial.location}`} className="rounded-[26px] border border-[#cddbf7] bg-[linear-gradient(180deg,#ffffff_0%,#f9fbff_100%)] p-6 shadow-[0_16px_40px_rgba(31,98,228,0.06)]">
              ...
              <div id="faqs" className="rounded-[30px] border border-[#cddbf7] bg-[linear-gradient(180deg,#f8fbff_0%,#ffffff_100%)] p-8 shadow-[0_20px_60px_rgba(31,98,228,0.08)]">
                ...
                <div className="mt-8 space-y-4">
                  {destinationFaqs.map((faq) => (
                    <details key={faq.question} className="group rounded-[22px] border border-[#cddbf7] bg-white p-5 shadow-sm">
        ...
        <section className="bg-[#f7f9fc] py-16 sm:py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 overflow-hidden rounded-[34px] border border-[#cddbf7] bg-[linear-gradient(135deg,#05263d_0%,#1f62e4_45%,#4f8ff0_100%)] p-8 text-white shadow-[0_28px_80px_rgba(31,98,228,0.22)] sm:p-10">
              <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                ...
                <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                  <ConsultationPopupTrigger
                    label="Book free consultation"
                    className="inline-flex h-12 items-center justify-center rounded-full bg-[#eef1f5] px-6 text-sm font-semibold text-slate-950 shadow-[0_16px_38px_rgba(79,143,240,0.22)] transition hover:-translate-y-0.5 hover:bg-[#dde5ef]"
                    withArrow
                  />
                  <Link
                    href="#costs"
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              <Link href="/" className="text-sm font-semibold text-[#1f62e4]">
                Back to homepage
              </Link>
            </div>
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              {relatedDestinations.map((item) => {
                ...
                return (
                  <article
                    key={item.slug}
                    className="group overflow-hidden rounded-[30px] border border-[#cddbf7] bg-white shadow-[0_18px_50px_rgba(31,98,228,0.08)] transition duration-300 hover:-translate-y-1.5 hover:border-[#8cb9ff] hover:shadow-[0_28px_80px_rgba(31,98,228,0.14)]"
                  >
                    <div className="relative min-h-[330px] overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.16),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(31,98,228,0.24),transparent_34%)]" />
                    ...
                    <div className="p-6">
                      <div className="inline-flex rounded-full border border-[#cddbf7] bg-[#f4f8fb] px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#1f62e4]">
                        Destination guide
                      </div>
