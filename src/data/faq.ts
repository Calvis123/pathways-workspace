...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Yes! Most countries allow international students to work part-time during their studies. The UK allows 20 hours/week, Canada allows 20 hours/week (off-campus), Australia allows 48 hours per fortnight, and most EU countries allow similar part-time work.",
  },
  {
